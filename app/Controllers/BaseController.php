...
class BaseController extends Controller
{
    ...
    public function timespan($datetime)
    {
        ...
        if($years > 0) {
            $timeSpan = $years.' Years '.$months.' Months '.$days.' Days '. $hours.' Hours '.$minutes.' minutes ago.' ;
        }
        elseif($months > 0) {
            $timeSpan = $months.' Months '.$days.' Days '. $hours.' Hours '.$minutes.' minutes ago.' ;
        }
        elseif($days > 0) {
            $timeSpan = $days.' Days '.$hours.' Hours '.$minutes.' minutes ago.' ;
        }
        elseif($hours > 0) {
            $timeSpan =  $hours.' Hours '.$minutes.' minutes ago.' ;
        }
        else {
