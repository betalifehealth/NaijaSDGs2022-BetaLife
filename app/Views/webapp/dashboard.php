<div class="content-body">
    <div class="container-fluid">
        <div class="form-head d-flex mb-3 mb-md-4 align-items-start mb-5">
            <div class="mr-auto d-none d-lg-block">
                <h3 class="text-black font-w600">Welcome to BetaLife, <?php echo session('name'); ?>!</h3>
                    ...
                    <div class="card-body">
                        <div class="media align-items-center">
                            <div class="media-body">
                                ...
                                <?php } ?>
                                <div class="d-flex flex-wrap">
                                    <h2 class="fs-40 font-w600 text-white mb-0 mr-3"><?php echo number_format($no_of_institutions) ?></h2>
                                </div>
                            </div>
                            <span class="border rounded-circle p-4">
            ...
            <div class="col-xl-3 col-xxl-6 col-sm-6">
                <div class="card gradient-bx text-white bg-info rounded">	
                    <div class="card-body">
                        <div class="media align-items-center">
                            <div class="media-body">
                                <p class="mb-1">Pending Activites</p>
                                <div class="d-flex flex-wrap">
                                    <h2 class="fs-40 font-w600 text-white mb-0 mr-3"><?php echo number_format($no_of_pending_activities); ?></h2>
                                </div>
                            </div>
                            <span class="border rounded-circle p-4">
            ...
            <div class="col-xl-3 col-xxl-4 col-lg-4">
                <div class="card">
                    <div class="card-header border-0 pb-0">
                        <h3 class="fs-20 mb-0 text-black">Expenses</h3>
                        <div class="dropdown d-inline-block">
                            <div class="btn-link text-primary dropdown-toggle mb-0 fs-14 text-primary" data-toggle="dropdown">
                                <span class="font-w500"><?php echo date('Y'); ?></span>
                            </div>
                            <div class="dropdown-menu dropdown-menu-left">
                                <a class="dropdown-item" href="javascript:void(0);"><?php echo date('Y', strtotime('-1 year')); ?></a>
                                <a class="dropdown-item" href="javascript:void(0);"><?php echo date('Y', strtotime('-2 years')); ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div>
                            <span class="text-info fs-26 font-w600 mr-3">NGN 0.00</span>
                            <span class="text-secondary fs-18 font-w400">NGN 0.00</span>
                        </div>
...
<?php 
    ...
    $chartDataReports = $requestModel->getReportBreakdownForUser();

    $bloodRequestReports = array_values($chartDataReports['requests']);
    $bloodOffersReports = array_values($chartDataReports['offers']);
?>

<script>
    var BloodRequestsChartData = [];
    var BloodOffersChartData = [];

    var BloodRequestsChartData = [<?php echo implode(", ", $bloodRequestReports); ?>];
    var BloodOffersChartData = [<?php echo implode(", ", $bloodOffersReports); ?>];
</script>