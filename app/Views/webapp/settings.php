...
<div class="content-body">
    <div class="container-fluid">
        <div class="page-titles">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">BetaLife</a></li>
        ...
        <div class="row">
            ...
            <div class="col-6">
                <a href="<?php echo base_url().'/settings/bank-information' ?>" class="">
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <p class="font-weight-bold">
                                ...
                                <small>Update your Bank Account information for payment disbursement.</small>
                            </div>
                        </div>
                    </div>
                </a>
