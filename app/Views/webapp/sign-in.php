                    ...
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            ...
                            <div class="col-xl-5 d-none d-xl-block" style="height: 700px">
                                <img src="<?php echo base_url('/webapp/images/hospital-register-bg-1.png');; ?>" class="img-fluid" style="height: inherit; object-fit: cover; width: inherit;" alt="" srcset="<?php echo base_url('/webapp/images/hospital-register-bg-1.png');; ?>">
                            </div>
                        </div>
                    </div>
                </div>
