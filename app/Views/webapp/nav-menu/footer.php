            <div class="footer">
                <div class="copyright">
                    <p>Copyright © BetaLife <?php echo date("Y"); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    ***********************************-->
	...
	<script src="<?php echo base_url().'/webapp/js/dashboard/dashboard-1.js'; ?>" type="text/javascript"></script>
	<script src="<?php echo base_url().'/webapp/js/custom.min.js?ver=1.2'; ?>" type="text/javascript"></script>
	...
	<script>
        ...
        function playSound() {
            const audio = new Audio("<?php echo base_url().'/webapp/sounds/alert-notification.wav'; ?>");
            audio.play();
        }
