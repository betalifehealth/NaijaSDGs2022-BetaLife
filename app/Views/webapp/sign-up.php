...
<head>
    ...
    <link href="<?php echo base_url().'/webapp/css/style.css'; ?>" rel="stylesheet" type="text/css"/>
        ...
        <style>
            <?php if (!$display_form) { ?>
                .background-image {
                    background-image: url('<?php echo base_url().'/webapp/images/betalife-register-bg-image.png' ?>');
...
<body class="h-100">
    ...
    <div class="authincation h-100 background-image">
        <div class="container-fluid h-100 d-flex justify-content-center h-100 align-items-center">
            <?php if ($display_form) { ?>
                <div class="row">
                    <div class="col-md-12">
                        <div class="authincation-content">
                            <div class="row no-gutters">
                                ...
                                <div class="col-xl-5 d-none d-xl-block" style="height: 700px">
                                    <img src="<?php echo $imageUrl; ?>" class="img-fluid" style="height: inherit; object-fit: cover; width: inherit;" alt="" srcset="<?php echo $imageUrl; ?>">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <?php } else { ?>
                <div>
                    <div class="row">
                        <div class="offset-lg-5 col-lg-7 mb-4">
                            <p class="text-center h2">Sign Up</p>
                        </div>

                        <div class="offset-lg-5 col-lg-7 rounded mb-3">
                        ...
                        <div class="offset-lg-5 col-lg-7 rounded mb-3">
                            <a href="<?php echo base_url().'/register/pharmacy'; ?>">
                                <div class="d-flex justify-content-between border border-dark bg-white shadow p-5 rounded">
                                    <span>
                                        <h5 class="text-dark">Pharmacy</h5>
                                    </span>
                                    <i class="fa fa-arrow-right mt-1"></i>
                                </div>
                            </a>
