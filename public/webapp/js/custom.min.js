...
function loadMyNewPage(target, dis_Url, page_change = false) {
	$.ajax({
		url : dis_Url,
		method : "GET",
		success:function(pageHtml) {
			if (page_change) {
				...
				$(target).html($(pageHtml).find('.main-content').html());
			}
			window.history.pushState('page2', '', dis_Url);
		},
		complete:function() {
			$("#preloader").hide();
			$("#main-wrapper").addClass("show");
...
$("body").on("change", ".multi-range", function(e) {
	var thisValueCount = $(this).val(),
		urgencyLevelTitle = $("option[level-name][value='"+thisValueCount+"']").attr("level-name");

	$(".range-level").text('Urgency Level: '+urgencyLevelTitle);
});

var months = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

function convertDateToWords(date_str) {
...
function copyToClipboard() {
	...
	setTimeout(() => {
		$(".copy-btn").html('<i class="fa fa-copy"></i>');
	}, 1500);
}
